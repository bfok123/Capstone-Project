...
var = tk.IntVar() # radio button var
lbl_genre = tk.Label(genre_frame, text="Genre: ")
r_btn_pop = tk.Radiobutton(genre_frame, text="Pop", variable=var, value=0)
r_btn_hiphop = tk.Radiobutton(genre_frame, text="Hip Hop", variable=var, value=1)
r_btn_country = tk.Radiobutton(genre_frame, text="Country", variable=var, value=2)
r_btn_minecraft = tk.Radiobutton(genre_frame, text="Minecraft", variable=var, value=3)
